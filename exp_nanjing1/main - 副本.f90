    ...
    open (9, file='vobs_tunnel02122_20ms.txt', status='old')

    Open (10, File='point1set_tunnel02122.txt', Status='old')
    Open (11, File='point2set_tunnel02122.txt', Status='old')
    Open (12, File='point3set_tunnel02122.txt', Status='old')
    Open (13, File='point4set_tunnel02122.txt', Status='old')

    Open (14, File='rho_pro_tunnel_20ms.txt', Status='old')
    Open (15, File='dep_pro_tunnel_20ms.txt', Status='old')


    ! Open (16, File='ht.txt', Status='old')

    Open (17, File='flag.dat', Status='unknown')
...
!        Write(6,*)'calculate Jacobi matrix ...'
    ...
    call bmuav(Atemp,size2,tot_para,u,v,l,eps,ka,s,e,work)   !    奇异值分解法
...
20  Format(13E14.6)   ! 每个测点的参数个数 2*nolayers-1

100 Format(E12.6)    ! Em.n表示该浮点数按单精度输出，总共m位，小数点后n位
    end program
    ...
    !																				  !
    !																				  !
    !   子函数引用自《Fortran常用算法程序集》（第二版）徐士良编著，清华大学出版社     !
    !																				  !
    !																				  !
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!                          subroutine program 3 奇异值分解
    !!                           Householder变换、QR算法
...
360 ks = ks - 1
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !!        subroutine program 4 subroutine program for 奇异值分解
